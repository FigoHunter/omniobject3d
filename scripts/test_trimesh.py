...
mesh = trimesh.load(r'Y:\hddisk5\users\yifei\omniobject3d\OpenXD-OmniObject3D-New\raw\decimated\anise\anise_001\Scan\Scan.obj')
with open(r'Y:\hddisk5\users\yifei\omniobject3d\OpenXD-OmniObject3D-New\raw\decimated\anise\anise_001\Scan\Scan.json','r') as f:
    j = json.load(f)
...
mat[2][3]=pos[2]
print(mat)
mat = np.matmul(np.matmul(coord,mat),np.linalg.inv(coord))
print(mat)
mesh.show()
